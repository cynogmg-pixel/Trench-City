...
if (function_exists('tc_enforce_feature_flag')) {
    tc_enforce_feature_flag('disable_crimes', 'Crimes Offline', 'Crimes are temporarily disabled by admin action.');
}
...
<div class="main-content">
    <div class="content-wrapper">
        ...
        .header {
            ...
            padding: 25px;
            margin-bottom: 30px;
            box-shadow: 0 8px 32px rgba(203, 161, 53, 0.35);
        }
        ...
        .header h1 {
            ...
            font-size: 2.5em;
            margin-bottom: 10px;
            text-shadow: 0 0 20px rgba(203, 161, 53, 0.7);
        }
        ...
        .commit-btn:hover {
            ...
            box-shadow: 0 4px 16px rgba(203, 161, 53, 0.6);
        }
        ...
        .history-table th {
            background: rgba(203, 161, 53, 0.35);
            color: var(--gold);
            padding: 12px;
            text-align: left;
