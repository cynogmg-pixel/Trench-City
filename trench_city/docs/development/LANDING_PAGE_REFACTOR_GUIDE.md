...
- **Gold Glow:** `box-shadow: 0 0 40px rgba(212,175,55,0.6)`
...
.landing-hero {
    background:
        linear-gradient(180deg, rgba(0,0,0,0.9) 0%, rgba(5,11,22,0.9) 50%, rgba(11,18,32,0.9) 100%),
...
.landing-hero {
    background:
        linear-gradient(180deg,
            rgba(0,0,0,0.9) 0%,        /* Top darkness */
            rgba(5,11,22,0.9) 50%,     /* Middle transition */
